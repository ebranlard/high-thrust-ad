...
---------------------- INPUT FILES ---------------------------------------------
"data/NREL5MW_ED_Pitch_-3.4.dat" EDFile        - Name of file containing ElastoDyn input parameters (quoted string)
...
"data/NREL5MW_AD15.05_Pitch_-3.4.dat" AeroFile      - Name of file containing aerodynamic input parameters (quoted string)
