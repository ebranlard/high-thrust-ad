...
---------------------- INPUT FILES ---------------------------------------------
"data/NREL5MW_ED_CT_0.30.dat" EDFile        - Name of file containing ElastoDyn input parameters (quoted string)
...
"data/NREL5MW_AD15.05_CT_0.30.dat" AeroFile      - Name of file containing aerodynamic input parameters (quoted string)
