...
cd CT_0.20 && sbatch runfile.sh && cd ..
cd CT_0.40 && sbatch runfile.sh && cd ..
cd CT_0.60 && sbatch runfile.sh && cd ..
cd CT_0.80 && sbatch runfile.sh && cd ..
cd CT_1.00 && sbatch runfile.sh && cd ..
cd CT_1.20 && sbatch runfile.sh && cd ..
cd CT_1.40 && sbatch runfile.sh && cd ..
cd CT_1.60 && sbatch runfile.sh && cd ..
cd CT_1.80 && sbatch runfile.sh && cd ..
